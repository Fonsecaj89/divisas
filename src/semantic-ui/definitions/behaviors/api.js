...
(function($, window, document, undefined) {
    ...
    $.api = $.fn.api = function(parameters) {
        ...
        $allModules.each(function() {
            ...
            let $context = settings.stateContext ? $(settings.stateContext) : $module;
            ...
            const
              ...
              const
                context            = this;
                let elapsedTime        = (new Date().getTime() - requestStartTime);
            ...
            if( $.isWindow(element) || settings.on == 'now' ) {
              ...
              return settings.on;
                    ...
                    templatedURL(action) {
                        action =
                            action || $module.data(metadata.action) || settings.action || false;
